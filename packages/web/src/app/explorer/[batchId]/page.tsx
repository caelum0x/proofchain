...
/**
 * Overview → Explorer → Batch detail. Read-only provenance, AI attestation +
 * findings, settlement state, and the full event timeline. Write actions live on
 * the authenticated /deals workspace.
 */
export default function ExplorerBatchPage() {
  ...
  return (
    <BatchDetail batchId={batchId} backHref="/explorer" sectionLabel="Explorer" />
  );
}
